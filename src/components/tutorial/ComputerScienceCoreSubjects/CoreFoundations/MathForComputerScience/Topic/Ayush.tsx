...
const Home: React.FC = () => (
  <div className="p-8 space-y-8 bg-white rounded-xl shadow-lg text-black mt-20">

    {/* ================= Engineering Mathematics Tutorials ================= */}
    <h1 className="text-4xl font-extrabold text-black border-b-2 pb-2">
      Engineering Mathematics Tutorials
    </h1>
    ...
    <h2 className="text-3xl font-bold text-black mt-8">Propositional and First-Order Logic</h2>
    ...
    {/* Set Theory */}
    <h2 className="text-3xl font-bold text-black mt-8">Set Theory</h2>
    <p className="leading-relaxed">
    ...
    {/* Combinatorics */}
    <h2 className="text-3xl font-bold text-black mt-8">Combinatorics</h2>
    <p className="leading-relaxed">
    ...
    {/* Probability */}
    <h2 className="text-3xl font-bold text-black mt-8">Probability</h2>
    <ol className="list-decimal ml-6 mt-2 space-y-1">
      <li>Probability</li>
    ...
    {/* Graph Theory */}
    <h2 className="text-3xl font-bold text-black mt-8">Graph Theory</h2>
    <ol className="list-decimal ml-6 mt-2 space-y-1">
    ...
    {/* Linear Algebra */}
    <h2 className="text-3xl font-bold text-black mt-8">Linear Algebra</h2>
    <ol className="list-decimal ml-6 mt-2 space-y-1">
    ...
    {/* Calculus */}
    <h2 className="text-3xl font-bold text-black mt-8">Calculus</h2>
    <ol className="list-decimal ml-6 mt-2 space-y-1">
    ...
    <h2 className="text-3xl font-bold text-black mt-8">Statistics and Numerical Methods</h2>
    <ol className="list-decimal ml-6 mt-2 space-y-1">
