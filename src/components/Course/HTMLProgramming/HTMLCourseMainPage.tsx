...
import { TABS, type TabName } from '../../../data/Course/HTMLData'; 
...
interface HTMLCourseMainPageProps {
  darkMode: boolean;
}

const HTMLCourseMainPage: React.FC <HTMLCourseMainPageProps>= ({darkMode}) => { 
...
export default HTMLCourseMainPage;