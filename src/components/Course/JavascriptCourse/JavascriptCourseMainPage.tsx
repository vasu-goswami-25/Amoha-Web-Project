...
import { TABS, type TabName } from '../../../data/Course/javascriptData';
...
interface JavascriptCourseMainPageProps {
  darkMode: boolean;
}

const JavascriptCourseMainPage: React.FC <JavascriptCourseMainPageProps>= ({darkMode}) => { 
...
export default JavascriptCourseMainPage;