...
// const EMSidebar: React.FC<SidebarProps> = ({ selected, onSelect }) => {
...
const EMSidebar: React.FC<SidebarProps> = ({ selected, onSelect, darkMode }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-2xl font-bold text-[#6334B9]">Eng Mathematics Tutorial</h2>
      </div>
