...
import { TABS, type TabName } from '../../../data/Course/javaData'; 
...
interface PythonCourseMainPageProps {
  darkMode: boolean;
}

const PythonCourseMainPage: React.FC <PythonCourseMainPageProps>= ({darkMode}) => { 
...
export default PythonCourseMainPage;