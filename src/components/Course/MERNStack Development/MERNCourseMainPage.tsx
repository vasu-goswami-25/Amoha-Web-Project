...
import { TABS, type TabName } from '../../../data/Course/MERNStackData'; 
...
interface MERNCourseMainPageProps {
  darkMode: boolean;
}

const MERNCourseMainPage: React.FC <MERNCourseMainPageProps>= ({darkMode}) => { 
...
export default MERNCourseMainPage;