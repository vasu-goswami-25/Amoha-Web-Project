...
import { TABS, type TabName } from '../../../data/Course/NextjsData'; 
...
interface NextjsCourseMainPageProps {
  darkMode: boolean;
}

const NextjsCourseMainPage: React.FC <NextjsCourseMainPageProps>= ({darkMode}) => { 
...
export default NextjsCourseMainPage;