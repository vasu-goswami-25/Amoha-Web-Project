...
import { TABS, type TabName } from '../../../data/Course/CSSData'; 
...
interface CSSCourseMainPageProps {
  darkMode: boolean;
}

const CSSCourseMainPage: React.FC <CSSCourseMainPageProps>= ({darkMode}) => { 
...
export default CSSCourseMainPage;