...
import { TABS, type TabName } from '../../../data/Course/AdvancedDSAData';
...
interface AlgorithmCourseMainPageProps {
  darkMode: boolean;
}

const  AlgorithmCourseMainPage: React.FC <AlgorithmCourseMainPageProps>= ({darkMode}) => { 
...
export default AlgorithmCourseMainPage;