...
import { TABS, type TabName } from '../../../data/Course/typescriptData';
...
interface TypescriptCourseMainPageProps {
  darkMode: boolean;
}

const TypescriptCourseMainPage: React.FC <TypescriptCourseMainPageProps>= ({darkMode}) => { 
...
export default TypescriptCourseMainPage;