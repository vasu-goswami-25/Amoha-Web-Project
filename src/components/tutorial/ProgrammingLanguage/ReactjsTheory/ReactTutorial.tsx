...
import { tutorialData, tutorialContent, type SidebarItem } from "../../../../data/tutorial/ReactjsTheory/reactjsData";

interface ReactjsTutorialProps {
  darkMode: boolean;
}
...
const ReactjsTutorial: React.FC<ReactjsTutorialProps> = ({ darkMode }) => {
  ...
  return (
    <div className={`flex h-screen ${darkMode ? "bg-gray-900 text-white" : "bg-white text-gray-900"}`}>
      <Sidebar
        ...
        darkMode={darkMode}
        tutorialTitle="Reactjs" // Added prop for dynamic title
      />
