...
import { TABS, type TabName } from '../../../data/Course/ReactData'; 
...
interface ReactCourseMainPageProps {
  darkMode: boolean;
}

const ReactCourseMainPage: React.FC <ReactCourseMainPageProps>= ({darkMode}) => { 
...
export default ReactCourseMainPage;