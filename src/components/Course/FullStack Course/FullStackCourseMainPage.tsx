...
import { TABS, type TabName } from '../../../data/Course/FullStackData'; 
...
interface FullStackCourseMainPageProps {
  darkMode: boolean;
}

const FullStackCourseMainPage: React.FC <FullStackCourseMainPageProps>= ({darkMode}) => { 
...
export default FullStackCourseMainPage;