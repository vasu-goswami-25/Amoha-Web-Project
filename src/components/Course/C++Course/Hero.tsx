...
            Level 1: C++ Programming – Self-Paced
          </h1>
          <p className={`mt-4 text-xl max-w-3xl leading-relaxed ${paragraphClasses}`}>
Kickstart your programming journey with C++ — the language trusted by FAANG engineers and competitive coders worldwide.
This course is built for complete beginners who want to master programming fundamentals the right way — through hands-on learning, logical thinking, and real-world problem-solving.
We won’t throw you into advanced algorithms right away. Instead, we’ll focus on building your core skills in implementation, debugging, mathematical reasoning, and code logic — the essential foundation of every great programmer
          </p>
