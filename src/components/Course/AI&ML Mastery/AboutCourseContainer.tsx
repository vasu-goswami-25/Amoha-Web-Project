      ...
      <div className="p-6">
        ...
        <ul className={`space-y-3 text-base mb-6 ${featureTextClasses}`}>
          <li className="font-medium">
            <span className="font-bold mr-1 text-[#6334B9]">80+ hrs</span> of recorded content from our live batch
          </li>
          <li className="font-medium">
            <span className="font-bold mr-1 text-[#6334B9]">1 year</span>Access to all video lectures
          </li>
          <li className="font-medium">
            <span className="font-bold mr-1 text-[#6334B9]">4 months</span> of mentor doubt support
          </li>
          <li className="font-medium">
            <span className="font-bold mr-1 text-[#6334B9]">Lifetime access</span> to assignments and projects

          </li>
        </ul>

        {/* Enroll Button */}
        <button className="w-full py-3 text-lg font-medium rounded-lg bg-[#6334B9] text-white hover:bg-[#6334B9] transition duration-300 shadow-lg cursor-pointer">
          Enroll Now
        </button>
      </div>
    </div>
