      ...
      <div className="p-6">
        ...
        <ul className={`space-y-3 text-base mb-6 ${featureTextClasses}`}>
          <li className="font-medium">
            <span className="font-bold mr-1 text-[#6334B9]">50+ hrs</span> of recorded content from our Live Batch
          </li>
          <li className="font-medium">
            <span className="font-bold mr-1 text-[#6334B9]">1 year</span>Access to all course material
          </li>
          <li className="font-medium">
            <span className="font-bold mr-1 text-[#6334B9]">3 months</span>  of Doubt Support from Mentors

          </li>
          <li className="font-medium">
            <span className="font-bold mr-1 text-[#6334B9]">Lifetime access</span>to Practice Projects and Styling Challenges
