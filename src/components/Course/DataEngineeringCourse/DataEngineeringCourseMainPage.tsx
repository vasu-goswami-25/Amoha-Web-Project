...
import { TABS, type TabName } from '../../../data/Course/DataEngineeringData';
...
interface DataEngineeringCourseMainPageProps {
  darkMode: boolean;
}

const  DataEngineeringCourseMainPage: React.FC <DataEngineeringCourseMainPageProps>= ({darkMode}) => { 
...
export default DataEngineeringCourseMainPage;