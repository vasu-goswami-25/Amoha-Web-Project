...
import { FEATURES_DATA } from '../../../data/Course/courseData';
        ...
        <div className="lg:col-span-2">
          ...
          <div className={`mt-8 p-4 sm:p-6 border-l-4 rounded-r-lg shadow-inner ${noteBoxClasses}`}>
            <p className="font-semibold">
              Important Note: <span className="font-normal">Doubt support covers questions up to 1300 Codeforces rating — the perfect starting range to move from beginner to competitive problem-solver.</span>
            </p>
