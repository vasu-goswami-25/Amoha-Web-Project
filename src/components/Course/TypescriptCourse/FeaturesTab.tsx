...
import { FEATURES_DATA } from '../../../data/Course/typescriptData';
...
              Important Note: <span className="font-normal">Doubt support includes problem difficulty up to beginner-intermediate range (≈ LeetCode Easy – Medium).</span>
            </p>
